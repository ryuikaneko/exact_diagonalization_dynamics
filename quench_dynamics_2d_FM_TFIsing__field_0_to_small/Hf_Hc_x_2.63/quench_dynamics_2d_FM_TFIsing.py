...
#    parser.add_argument('-hi',metavar='hi',dest='hi',type=np.float,default=1e10,help='set hi (default 1e10 ~ infinity)')
    parser.add_argument('-hi',metavar='hi',dest='hi',type=np.float,default=0.0,help='set hi (default 0.0)')
    parser.add_argument('-hf',metavar='hf',dest='hf',type=np.float,default=8.0067194,help='set hf (default 2.63*Hc = 8.0067194 (Hc=3.04438))')
    parser.add_argument('-tau',metavar='tau',dest='tau',type=np.float,default=2.0,help='set tau (max time, default 2.0)')
...
#
    fig100 = plt.figure()
    fig100.suptitle("energy0")
    plt.plot(time_steps_4,ene0)
    plt.xlabel("$t/4$")
    fig100.savefig("fig_ene0.png")
#
#    fig1 = plt.figure()
...
#
    fig101 = plt.figure()
    fig101.suptitle("energy")
    plt.plot(time_steps_4,ene)
    plt.xlabel("$t/4$")
    fig101.savefig("fig_ene.png")
#
    fig2 = plt.figure()
...
#
    fig105 = plt.figure()
    fig105.suptitle("mz")
    plt.plot(time_steps_4,mz)
    plt.xlabel("$t/4)$")
    fig105.savefig("fig_mz.png")
#
#    fig6 = plt.figure()
